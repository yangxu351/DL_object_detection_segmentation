'''
https://github.com/2017TJM/DIoU-SSD-pytorch/blob/e9a86b9fe79ed6ea5e92ebecf52309d799ff9bab/utils/box/box_utils.py
...
def bbox_overlaps_ciou(bboxes1, bboxes2):
    '''
    complete iou w.r.t. area overlap, center-distance, aspect-ratio    
    '''
    rows = bboxes1.shape[0]
    cols = bboxes2.shape[0]
...
def bbox_overlaps_giou(bboxes1, bboxes2):
    '''
    |C - B \cup B^{gt}|/|C|, C is the smallest box containing both B and B^{gt}
    '''
    rows = bboxes1.shape[0]
    cols = bboxes2.shape[0]
    ious = torch.zeros((rows, cols))
