...
class FasterRCNNBase(nn.Module):
    ...
    def __init__(self, backbone, rpn, roi_heads, transform, mask_head=None, withRPNMask=False, feat_attention=None): 
...
class FasterRCNN(FasterRCNNBase):
    ...
    def __init__(self, backbone, num_classes=None,
                 ...
                 # mask parameters
                 mask_head=None, withRPNMask=False, soft_val=1., withMaskFeature=False, layer_levels=['0', '1', '2', '3']):
        ...
        super(FasterRCNN, self).__init__(backbone, rpn, roi_heads, transform, mask_head=mask_head, withRPNMask=withRPNMask, feat_attention=feat_attention)  #
