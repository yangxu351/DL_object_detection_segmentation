...
from .mask_attention_features import MaskAttention
...
class FasterRCNNBase(nn.Module):
    ...
    def __init__(self, backbone, rpn, roi_heads, transform, mask_head=None, withRPNMask=False, la=None, ga=None, feat_attention=None):  # 
...
class FasterRCNN(FasterRCNNBase):
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        super(FasterRCNN, self).__init__(backbone, rpn, roi_heads, transform, mask_head=mask_head, withRPNMask=withRPNMask, la=la, ga=ga, feat_attention=feat_attention)  #
