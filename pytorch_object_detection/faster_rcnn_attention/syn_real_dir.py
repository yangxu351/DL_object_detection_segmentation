...
def get_dir_arg(syn_cmt='', real_cmt='', workbase_data_dir='./real_syn_wdt_vockit', ):
    ...
    if syn_cmt:
        ...
        parser.add_argument("--syn_workdir_data", type=str, default='{}/{}', help="workdir data base synwdt ./real_syn_wdt_vockit/\{cmt\}")
        parser.add_argument("--syn_workdir_main", type=str, default='{}/Main', help="\{syn_workdir_data\}/Main ")    
        ...
        parser.add_argument("--real_workdir_data", type=str, default='{}/{}', help="workdir data base synwdt ./real_syn_wdt_vockit/\{cmt\}")
        parser.add_argument("--real_workdir_main", type=str, default='{}/Main', help="\{real_workdir_data\}/Main ")    
    ...
    if syn_cmt:
        args.syn_data_dir = args.syn_data_dir.format(args.syn_base_dir, syn_cmt)
        args.syn_data_imgs_dir = args.syn_data_imgs_dir.format(args.syn_data_dir, syn_cmt)
        args.syn_data_segs_dir = args.syn_data_segs_dir.format(args.syn_data_dir, syn_cmt)

        args.syn_yolo_annos_dir = args.syn_yolo_annos_dir.format(args.syn_base_dir, syn_cmt, args.link_r, args.min_region, args.px_thres, args.whr_thres)
        args.syn_voc_annos_dir = args.syn_voc_annos_dir.format(args.syn_base_dir, syn_cmt, args.link_r, args.min_region, args.px_thres, args.whr_thres)
        args.syn_box_dir = args.syn_box_dir.format(args.syn_base_dir, syn_cmt, args.link_r, args.min_region, args.px_thres, args.whr_thres)

        args.syn_workdir_data = args.syn_workdir_data.format(workbase_data_dir, syn_cmt)
        args.syn_workdir_main = args.syn_workdir_main.format(args.syn_workdir_data)
        if not os.path.exists(args.syn_workdir_data):
            os.makedirs(args.syn_workdir_data)
        if not os.path.exists(args.syn_workdir_main):
            os.makedirs(args.syn_workdir_main)
    else:
        args.real_imgs_dir = args.real_imgs_dir.format(args.real_base_dir, real_cmt)
        args.real_labelme_dir = args.real_labelme_dir.format(args.real_base_dir, real_cmt)
        args.real_yolo_annos_dir = args.real_yolo_annos_dir.format(args.real_base_dir, real_cmt)
        args.real_voc_annos_dir = args.real_voc_annos_dir.format(args.real_base_dir, real_cmt)
        args.real_box_dir = args.real_box_dir.format(args.real_base_dir, real_cmt)

        args.real_workdir_data = args.real_workdir_data.format(workbase_data_dir, real_cmt)
        args.real_workdir_main = args.real_workdir_main.format(args.real_workdir_data)
        if not os.path.exists(args.real_workdir_data):
            os.makedirs(args.real_workdir_data)
        if not os.path.exists(args.real_workdir_main):
            os.makedirs(args.real_workdir_main)
    # args.workdir_imgsets = args.workdir_imgsets.format(args.workdir_data)
    # args.real_workdir_data = args.real_workdir_data.format(args.real_workdir_data)
